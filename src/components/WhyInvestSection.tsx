...
export default function WhyInvestSection() {
  ...
  return (
    <section id="por-que-investir" className="bg-white py-24 border-b border-slate-200 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          ...
          {LAZER_UNITS.map((unit, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className={`lg:col-span-8 relative rounded-sm overflow-hidden shadow-xl aspect-[16/9] bg-forest-dark border border-slate-200 ${
                  ...
                  {unit.id === 'uniko-infra' ? (
                    ...
                    <>
                      <img
                        ...
                        className="w-full h-full object-cover filter brightness-[0.9] hover:brightness-100 transition-all duration-700 hover:scale-101"
                      />
                      {/* Glass Card Overlay reflecting the information blocks in the screenshot */}
                      <div className="absolute right-4 bottom-4 md:right-6 md:bottom-6 max-w-sm bg-white/95 backdrop-blur-md p-6 rounded-sm shadow-2xl border-l-4 border-accent text-text-main space-y-3">
                        <span className="inline-block text-[9px] font-bold font-montserrat tracking-widest text-accent uppercase">
                          {unit.badge}
                        </span>
                        <h4 className="text-base font-extrabold font-montserrat text-primary leading-tight uppercase">
                          {unit.title}
                        </h4>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center gap-1 text-[10px] font-bold font-montserrat text-accent hover:text-accent-hover uppercase tracking-wider cursor-pointer"
                        >
                          Solicitar Payback ↗
                        </a>
                      </div>
                      ...
                      <div className="absolute top-4 left-4 bg-forest-dark/70 text-white/90 px-3 py-1 text-[9px] font-mono tracking-widest uppercase rounded-sm">
                ...
                <div className={`lg:col-span-4 space-y-5 ${
                  ...
                  <h3 className="text-2xl md:text-3xl font-light font-serif text-primary leading-tight">
                    {unit.tagline}
                  </h3>
                  ...
                  <ul className="space-y-2.5 pt-2">
                    {bullets.map((bullet, bidx) => (
                      <li key={bidx} className="flex items-start gap-2.5 text-xs text-text-muted">
        ...
        <div className="mt-16 text-center">
          <motion.a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-block px-12 py-4 bg-forest text-white hover:bg-forest-light text-xs font-bold font-montserrat uppercase tracking-[0.2em] rounded-sm shadow-md transition-colors cursor-pointer"
          >
            Entre em Contato
          </motion.a>
        </div>
